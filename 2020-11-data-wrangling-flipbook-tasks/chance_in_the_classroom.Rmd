...
One goal of data science and statistics classes is to give students practice with tools so they are comfortable preparing and analyzing data.  A new way to engage students with such tasks is by using the new {flipbookr} package to build outcome-oriented exercises.  
